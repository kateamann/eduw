 ...
 * Edinburgh Unwrapped.
 *
 * This file adds the tour page template to the Edinburgh Unwrapped Theme.
 *
 * Template Name: Tour
 *
...
add_filter( 'body_class', 'eduw_add_tour_class' );
/**
 * Adds tour page body class.
 *
 * @since 2.0.0
 *
 ...
 */
function eduw_add_tour_class( $classes ) {

    $classes[] = 'single-tours';
    return $classes;
